...
const {user} = useContext(AuthContext);
  ...
  return (
    <div className='my-10 flex flex-col md:flex-row justify-around gap-5  items-center min-h-[calc(100vh-306px)] md:max-w-screen-xl mx-auto '>
      {/* Job Details */}
      ...
      <section className='p-6 w-full  bg-white rounded-md shadow-md flex-1 md:min-h-[350px]'>
        ...
        <form onSubmit={handlePlaceBidForm}>
